...
class produtos{
    ...
    public function inserirProduto($dados){
        ...
        $sql = "INSERT INTO `produtos`(`id_categoria`,`id_imagem`,`id_usuario`,`nome`,`descricao`,`quantidade`,`preco`,`dataCaptura`) VALUES ('$dados[0]','$dados[1]','$dados[2]','$dados[3]','$dados[4]','$dados[5]','$dados[6]','$data')";
